	...
	public NodeInterface findSuccessor(BigInteger key) throws RemoteException {
		...
		if(succstub != null) {
			...
			if(cond) {
				...
				NodeInterface highest_pred = findHighestPredecessor(key);   // if logic returns false; call findHighestPredecessor(key)
				return highest_pred.findSuccessor(key);  // do return highest_pred.findSuccessor(key) - This is a recursive call until logic returns true
			}
		}
